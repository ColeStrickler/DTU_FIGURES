...
# Load + clean
# -----------------------------
df = pd.read_csv("data/fix_unfold_boom3.2.csv", skipinitialspace=True)
...
plt.savefig("figures/fix_unfold_bw_boom.png", bbox_inches="tight")
plt.savefig("figures/fix_unfold_bw_boom.pdf", bbox_inches="tight")
plt.show()