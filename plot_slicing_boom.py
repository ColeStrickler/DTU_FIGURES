...
# Load + clean
# -----------------------------
df = pd.read_csv("data/slicing_boom1.0.csv", skipinitialspace=True)
...
plt.savefig("figures/slicing_boom.png", bbox_inches="tight")
plt.savefig("figures/slicing_boom.pdf", bbox_inches="tight")
plt.show()