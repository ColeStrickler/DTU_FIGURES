...
# Load + clean
# -----------------------------
df = pd.read_csv("data/fix_img_augmentation_boom3.2.csv", skipinitialspace=True)
#print(df)
...
plt.savefig("figures/fix_imAug_bw_boom.png", bbox_inches="tight")
plt.savefig("figures/fix_imAug_bw_boom.pdf", bbox_inches="tight")
plt.show()