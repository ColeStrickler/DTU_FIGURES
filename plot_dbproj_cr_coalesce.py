...
# Load + clean
# -----------------------------
df = pd.read_csv("data/coalesce_dbproj_boom3.2.csv", skipinitialspace=True)
...
plt.savefig("figures/coalesce_dbproj_boom_cr.png", bbox_inches="tight")
plt.savefig("figures/coalesce_dbproj_boom_cr.pdf", bbox_inches="tight")
plt.show()