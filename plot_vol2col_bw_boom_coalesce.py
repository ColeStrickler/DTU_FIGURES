...
# Load + clean
# -----------------------------
df = pd.read_csv("data/coalesce_vol2col_boom3.2.csv", skipinitialspace=True)
...
plt.savefig("figures/coalesce_vol2col_bw_boom.png", bbox_inches="tight")
plt.savefig("figures/coalesce_vol2col_bw_boom.pdf", bbox_inches="tight")
plt.show()