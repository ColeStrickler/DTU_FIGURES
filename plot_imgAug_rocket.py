...
# Load + clean
# -----------------------------
df = pd.read_csv("data/img_augmentation_rocket1.0.csv", skipinitialspace=True)
...
plt.savefig("figures/imgAug_rocket.png", bbox_inches="tight")
plt.savefig("figures/imgAug_rocket.pdf", bbox_inches="tight")
plt.show()