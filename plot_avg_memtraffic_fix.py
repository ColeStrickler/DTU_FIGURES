...
df = pd.read_csv("data/fix_avg_memory_traffic_boom.csv")
...
plt.savefig("figures/fix_avg_memtraffic.png", bbox_inches="tight")
plt.savefig("figures/fix_avg_memtraffic.pdf", bbox_inches="tight")
plt.show()