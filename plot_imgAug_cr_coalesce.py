...
# Load + clean
# -----------------------------
df = pd.read_csv("data/coalesce_img_augmentation_boom3.2.csv", skipinitialspace=True)
...
x = np.arange(3) * x_axis_width_scale
bar_width = 0.1
...
plt.savefig("figures/coalesce_imgaug_boom_cr.png", bbox_inches="tight")
plt.savefig("figures/coalesce_imgaug_boom_cr.pdf", bbox_inches="tight")
plt.show()