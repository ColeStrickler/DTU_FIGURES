...
# Load CSV
df = pd.read_csv("data/conv_desktop.csv")
...
plt.title("Normalized Benchmark Performance Intel(R) Xeon(R)")
...
# Save to file
plt.savefig("figures/conv_desktop.png", dpi=300, bbox_inches='tight')
