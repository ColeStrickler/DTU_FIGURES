...
# Load data
# -----------------------------
df = pd.read_csv("data/coalesce_avg_memory_traffic_boom.csv")
...
# Export for LaTeX
plt.savefig("figures/coalesce_avg_cache_stats.pdf", bbox_inches="tight")
plt.savefig("figures/coalesce_avg_cache_stats.png", dpi=300, bbox_inches="tight")
