...
# Load + clean
# -----------------------------
df = pd.read_csv("data/fix_dbproj_boom3.2.csv", skipinitialspace=True)
...
plt.savefig("figures/fix_dbproj_boom_cr.png", bbox_inches="tight")
plt.savefig("figures/fix_dbproj_boom_cr.pdf", bbox_inches="tight")
plt.show()