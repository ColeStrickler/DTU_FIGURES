...
# Load + clean
# -----------------------------
df = pd.read_csv("data/unfold_boom3.2.csv", skipinitialspace=True)
...
plt.savefig("figures/unfold_boom.png", bbox_inches="tight")
plt.savefig("figures/unfold_boom.pdf", bbox_inches="tight")
plt.show()