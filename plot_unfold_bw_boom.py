...
# Load + clean
# -----------------------------
df = pd.read_csv("data/unfold2_boom1.0.csv", skipinitialspace=True)
...
plt.savefig("figures/unfold_bw_boom.png", bbox_inches="tight")
plt.savefig("figures/unfold_bw_boom.pdf", bbox_inches="tight")
plt.show()