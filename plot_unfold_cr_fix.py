...
df["tensor_size"] = tensor_sizes.map({'64': "64MB",'32': "64MB", '16': "32MB", '8': "16MB"})
...
plt.savefig("figures/fix_unfold_boom_cr.png", bbox_inches="tight")
plt.savefig("figures/fix_unfold_boom_cr.pdf", bbox_inches="tight")
plt.show()